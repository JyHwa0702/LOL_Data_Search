...
public class KakaoDto {
    ...
    public KakaoDto(Kakao kakao){
        ...
        this.sub=kakao.getSub();
        this.iat=kakao.getIat();
        this.exp=kakao.getExp();
        this.auth_time=kakao.getAuth_time();
        this.nonce=kakao.getNonce();
    ...
    public Kakao toEntity(KakaoDto kakaoDto){
        Kakao kakao = new Kakao(kakaoDto);
        return kakao;
    }
}
